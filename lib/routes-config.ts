...
export const ROUTES: EachRoute[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Entities Layer", href: "/entities-layer" },
      { title: "Data Layer", href: "/data-layer" },
      { title: "Service Layer", href: "/service-layer" },
      { title: "Validator Layer", href: "/validator-layer" },
      { title: "ViewModels Layer", href: "/viewModels-layer" },
    ],
  },
];
